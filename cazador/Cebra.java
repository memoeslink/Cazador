 ...
 * @author Memoeslink
 */
public class Cebra implements Animal{
    int hp = 0;
    int hpdamage = 0;

    @Override
    public boolean Huir() {
        JOptionPane.showMessageDialog(null, "La " + this.getName() + " ha huído.");
        return true;
    }

    @Override
    public boolean Atacar() {
        JOptionPane.showMessageDialog(null, "La " + this.getName() + " te ha mordisqueado.");
        return true;
    }
